    ...
    return (
        <div className='bg-black h-fit footer flex-1 text-white  items-center justify-center'>
            <div className='flex items-center justify-around px-1 py-3 flex-wrap bg-fuchsia-800'>
                ...
                <div className=' linksbox justify-around flex'><a href="https://www.instagram.com/geekslearneasy/"><AiOutlineInstagram className='text-3xl hover:invert hover:cursor-pointer' /></a> <a href="https://www.facebook.com/profile.php?id=100093562741971"><FaFacebook className='text-3xl hover:invert hover:cursor-pointer' /></a> <a href="https://www.linkedin.com/in/geeks-learn-easy-424b4b279"><FaLinkedin className='text-3xl hover:invert hover:cursor-pointer' /></a><a href="https://twitter.com/Geekslearneasy"><FaTwitterSquare className='text-3xl hover:invert hover:cursor-pointer' /></a><a href="https://www.youtube.com/@Geekslearneasy/about"><FaYoutube className='text-3xl hover:invert hover:cursor-pointer' /></a></div>
            </div>
