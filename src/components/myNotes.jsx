...
export default function MyNotes() {
    ...
    return (
        <div className='home min-h-screen text-white'>
            {myNotes.length == 0 && <div className='flex items-center justify-center h-screen'><div className='mb-10'><h1 className='text-xl text-gray-300 text-center'>Add your daily target here..</h1><div className=' text-sm text-center mt-1 text-gray-500'>click on the "+" button to start</div></div></div>}
            {myNotes.map((e, i) => {
